...
<html>
	<head>
		...
		<title></title>
		<style type="text/css">
			h3 {font-size:16px; line-height: 10px; letter-spacing:1px;}
			table {
...
</html>", cc: '', charset: 'UTF-8', from: 'rg_164518@126.com', mimeType: 'text/plain', replyTo: '', subject: "构建版本失败", to: "1918520482@qq.com";
        }
        unstable {
